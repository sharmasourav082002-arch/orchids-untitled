            ...
            >
              ...
              <div className="px-6 py-5 border-b border-zinc-800 bg-zinc-900/50">
                <p className="text-xs font-black uppercase tracking-widest mb-4 text-zinc-400">
                  {remaining > 0 
                    ? `Need ₹${remaining.toLocaleString('en-IN')} for free shipping` 
                ...
                <div className="flex justify-between mt-2">
                  ...
                  <span className="text-[10px] font-black text-zinc-400">₹{FREE_SHIPPING_THRESHOLD.toLocaleString('en-IN')}</span>
                </div>
              </div>
                      ...
                      <div className="flex flex-1 flex-col justify-between py-1">
                        <div>
                          <div className="flex justify-between items-start">
                            ...
                            <p className="text-sm font-black text-amber-400">₹{Number(item.price).toLocaleString('en-IN')}</p>
                          </div>
              ...
              <div className="border-t border-zinc-800 px-6 py-8 space-y-6 bg-zinc-900/50">
                ...
                <div className="flex items-end justify-between py-4">
                  ...
                  <div className="text-right">
                    ...
                    >
                      ₹{cartTotal.toLocaleString('en-IN')} <span className="text-sm text-zinc-500">INR</span>
                    </motion.p>
