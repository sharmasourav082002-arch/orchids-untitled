          ...
          <Sheet>
            <SheetTrigger asChild>
              <motion.div whileHover={{ y: -2 }}>
                <Button variant="ghost" size="icon" className="relative h-14 w-14 rounded-2xl bg-black text-white dark:bg-white dark:text-black shadow-[0_10px_20px_rgba(0,0,0,0.2)] dark:shadow-[0_10px_20px_rgba(255,255,255,0.1)] transition-transform active:scale-95">
